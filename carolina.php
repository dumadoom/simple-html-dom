...
<br>
<center>
	<font face='Ubuntu' size='6' color='red'><b>DomGrabber</b></font></center>
	<div class="toto">
...
if(isset($_GET['hcafe'])){
	...
	echo'
	<form action="index.php" method="get">
		<input type="hidden" name="page" value="hcafe"/>
		<font face="Ubuntu" size="6" color="red">hCafe Stealer</font><p>
		<font face="Ubuntu" size="4" color="white">
		code : <input type="text" style="width:4%;" placeholder="name/code" name="c0"><br>
		amount : <input type="text" style="width:2%;" placeholder="225" name="am0"><br>
		img extension : <input type="text" style="width:4%;" placeholder=".jpg / .png" name="ext">
		<br>
		<font face="Ubuntu" size="6" color="gold">	
-------------<br></font>
		<input type="submit" name="hcaf" value="LOCK">
		<br>
		</font>
		<br>
	</form>';
...
for($i=1;$i<=$am0;$i++){
	if ($i < 10) {
		echo" <img width='230' height='340' src=";
		echo "https://cdn.hentai.cafe/manga/content/comics/";
		echo $c0; echo'/';
		echo '0'.$i; echo $ext;
		echo ">";    
	} else {
...
/** HM  */
/** FF  */
if(isset($_GET['fanfox'])){
echo'
	<form action="index.php" method="get">
		<input type="hidden" name="page" value="fanfox"/>
		<font face="Ubuntu" size="6" color="gold">
-------------<br></font>
		<font face="Ubuntu" size="6" color="red">FanFox Stealer</font><p>
		<font face="Ubuntu" size="4" color="gold">
		subdomain gallery : <input type="text" style="width:8%;" placeholder="http://s.fanfox.net/" name="subd"><br>
		folder : <input type="text" style="width:4%;" placeholder="store/manga/" name="f0"><br>
		code : <input type="text" style="width:4%;" placeholder="28343/119.0/compressed/i20190228_204440_8**" name="c0"> **<br>
		amount : <input type="text" style="width:2%;" placeholder="26" name="am0"> if 000 --> *, 0000 --> ***<br>
		amount1 : <input type="text" style="width:2%;" placeholder="30" name="am1"><br>
		img extension : <input type="text" style="width:3%;" placeholder=".jpg" name="ext">
		<br>
		<font face="Ubuntu" size="6" color="gold">	
-------------<br></font>
		<input type="submit" name="ffox" value="LOCK">
		<br>
		</font>
		<br>
	</form>';
...
<p>
	...
	<font face='Ubuntu' size='3' color='green'><b>Nh Stealer</b></font></span></a>
	<font size='2' color='gray'><b>[######.net]</b></font>
<br>
	<font size='5'>*</font>
	<a href="?hcafe" rel="nofollow" target="_blank">
	<font face='Ubuntu' size='3' color='green'><b>HC Stealer</b></font></span></a>
	<font size='2' color='gray'><b>[######.com]</b></font>
<br>
	<font size='5'>*</font>
	<a href="?hitomi" rel="nofollow" target="_blank">
	<font face='Ubuntu' size='3' color='green'><b>Hitomi.la Stealer</b></font></span></a>
	<font size='2' color='gray'><b>[######.la]</b></font>
<br>
	<font size='5'>*</font>
	<a href="beta.php" rel="nofollow" target="_blank">
	<font face='Ubuntu' size='3' color='green'><b>SH Stealer</b></font></span></a>
	<font size='2' color='gray'><b>[######.com]</b></font> 
	<font size='3' color='gold'><b>BETA</b></font>
<br>
	<font size='5'>*</font>
	<a href="beta.php" rel="nofollow" target="_blank">
	<font face='Ubuntu' size='3' color='green'><b>H2R Stealer</b></font></span></a>
	<font size='2' color='gray'><b>[######.com]</b></font>
	<font size='3' color='gold'><b>BETA</b></font>
<br>
	<font size='5'>*</font>
	<a href="?pururin" rel="nofollow" target="_blank">
	<font face='Ubuntu' size='3' color='green'><b>Pr Stealer</b></font></span></a>
	<font size='2' color='gray'><b>[######.io]</b></font>
<br>
	<font size='5'>*</font>
	<a href="?hentaifox" rel="nofollow" target="_blank">
	<font face='Ubuntu' size='3' color='green'><b>HF Stealer</b></font></span></a>
	<font size='2' color='gray'><b>[######.com]</b></font>
<br>
	<font size='5'>*</font>
	<a href="?hmanga" rel="nofollow" target="_blank">
	<font face='Ubuntu' size='3' color='green'><b>HM Searcher Stealer</b></font></span></a>
	<font size='2' color='gray'><b>[######.com]</b></font>
<br>
	<font size='5'>*</font>
	<a href="beta.php" rel="nofollow" target="_blank">
	<font face='Ubuntu' size='3' color='green'><b>eH Stealer</b></font></span></a>
	<font size='2' color='gray'><b>[######]</b></font>
	<font size='3' color='gold'><b>BETA</b></font>
<br>
	<font size='5'>*</font>
	<a href="fanfox?" rel="nofollow" target="_blank">
	<font face='Ubuntu' size='3' color='green'><b>FF Stealer</b></font></span></a>
	<font size='2' color='gray'><b>[######]</b></font>
<br>
<font size='5'>*</font>
	<a href="dnesia.php" rel="nofollow" target="_blank">
	<font face='Ubuntu' size='3' color='green'><b>D Grabber</b></font></span></a>
	<font size='2' color='gray'><b>[Grab everything img tags]</b></font>
</p>	
<hr color=gold width=40%>
